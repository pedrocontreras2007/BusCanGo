...
const ScOrderFulFillmentBadge = class {
    ...
    render() {
        return (h("sc-tag", { key: '14fc29be42e6ec48331c079edda00382ea46d653', type: type === null || type === void 0 ? void 0 : type[this === null || this === void 0 ? void 0 : this.status], pill: this.pill }, (status === null || status === void 0 ? void 0 : status[this.status]) || this.status));
    }
};
