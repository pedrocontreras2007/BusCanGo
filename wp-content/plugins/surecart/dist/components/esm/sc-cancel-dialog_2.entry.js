...
const ScCancelDialog = class {
    ...
    render() {
        return (h("sc-dialog", { key: 'ac95d364e36afff3ca01440d906d7b64e430cebc', style: {
                '--width': this.step === 'survey' ? '675px' : '500px',
                '--body-spacing': 'var(--sc-spacing-xxx-large)',
            }, noHeader: true, open: this.open, onScRequestClose: () => this.close() }, h("div", { key: '3431872068cf3f33248f79aed510490fac542622', class: {
                cancel: true,
            } }, h("sc-button", { key: '6b9bd56d3bc430623d79d84bbde02c7e655456fb', class: "close__button", type: "text", circle: true, onClick: () => this.close() }, h("sc-icon", { key: '1e03921294f537d5aaaa945125635a1bb6faa665', name: "x" })), this.step === 'cancel' && (h("sc-subscription-cancel", { key: '0ace732ea967c2c5d6c92562b2772e99e7da2c61', subscription: this.subscription, protocol: this.protocol, reason: this.reason, comment: this.comment, onScAbandon: () => this.close(), onScCancelled: () => {
                this.scRefresh.emit();
                this.reset();
                this.scRequestClose.emit('close-button');
            } })), this.step === 'survey' && (h("sc-cancel-survey", { key: 'a5b80b6e54e0975b71b47a9eb9ab280df16b7056', protocol: this.protocol, onScAbandon: () => this.close(), onScSubmitReason: e => {
                const { comment, reason } = e.detail;
                this.reason = reason;
                this.comment = comment;
                this.step = (reason === null || reason === void 0 ? void 0 : reason.coupon_enabled) ? 'discount' : 'cancel';
            } })), this.step === 'discount' && (h("sc-cancel-discount", { key: 'e7313bc1344a639167d974ac80cf6d8df99249c6', protocol: this.protocol, subscription: this.subscription, reason: this.reason, comment: this.comment, onScCancel: () => (this.step = 'cancel'), onScPreserved: () => {
                this.scRefresh.emit();
                this.reset();
                this.scRequestClose.emit('close-button');
            } })))));
