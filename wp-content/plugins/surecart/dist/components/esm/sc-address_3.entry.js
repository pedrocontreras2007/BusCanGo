...
const ScCheckbox = class {
    ...
    render() {
        ...
        return (h(Tag, { key: 'dd6844e630a087b0c6503f4adc57c804bd0f79cc', part: "base", class: {
                'checkbox': true,
...
const ScTaxIdInput = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (h(Fragment, { key: '308c6848e3dae1c612fc5d97abfd75230202135d' }, h("sc-input", { key: '4c4876c2ff8ec3f87d594cd23ec91615b1240088', name: "tax_identifier.number_type", required: this.required, value: this.type, style: { display: 'none' } }), h("sc-input", { key: 'cf6908433a4ac24dcb7e44075170b0ef34e8a8e6', ref: el => (this.input = el), label: this.getZoneLabel(), "aria-label": wp.i18n.__('Tax ID', 'surecart'), placeholder: wp.i18n.__('Enter Tax ID', 'surecart'), name: "tax_identifier.number", value: this.number, onScInput: (e) => {
