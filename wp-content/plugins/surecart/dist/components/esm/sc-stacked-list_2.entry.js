...
const ScStackedList = class {
    ...
    render() {
        return h("slot", { key: '26aa608eb362ed58cee5315176b78eed5cddfc90' });
    }
};
...
const ScStackedListRow = class {
    ...
    render() {
        ...
        return (h(Tag, { key: '3535cdc7f9d7d7bfb0fb8eff83c3146abe799b32', href: this.href, target: this.target, part: "base", class: {
                'list-row': true,
            ...
            } }, h("span", { key: '848a059a9e57bf9a6a20a0b7dc4da54909aad907', class: "list-row__prefix" }, h("slot", { key: 'f9ade5b3cf0a7bb1ab1221475d36316c7eff4f15', name: "prefix", onSlotchange: () => this.handleSlotChange() })), h("slot", { key: '22f1256be5934609bca4f4a3771bdde1d22468ec', onSlotchange: () => this.handleSlotChange() }), h("span", { key: '5e6949661579e49cfbb92e3b33c3da7528c81e1c', class: "list-row__suffix" }, h("slot", { key: '3eaa83e450ffe4d6ab69a1faa231a23611096d7b', name: "suffix", onSlotchange: () => this.handleSlotChange() }))));
    }
