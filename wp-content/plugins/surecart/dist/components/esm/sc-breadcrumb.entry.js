...
const ScBreadcrumb = class {
    ...
    render() {
        ...
        return (h("div", { key: '8599d14c998b5caf7616897ec666844b2d745724', part: "base", class: {
                'breadcrumb-item': true,
                'breadcrumb-item--has-prefix': this.hasPrefix,
                'breadcrumb-item--has-suffix': this.hasSuffix,
            } }, h("span", { key: 'dd54a9100ef9cbaba32888fb2d81336b9c1b0186', part: "prefix", class: "breadcrumb-item__prefix" }, h("slot", { key: '5a161742a396e0a47cb42a081008591c30fabdcf', name: "prefix" })), h(Tag, { key: 'df1cdd13909e78507ec2170313f54f854d362ce9', part: "label", class: "breadcrumb-item__label breadcrumb-item__label--link", href: this.href, target: this.target, rel: this.rel }, h("slot", { key: '46082728125574e58343ccb745bf99b0b10f8071' })), h("span", { key: 'f60d947ceb4d7a8ab460de9a32cb8ac6bafa6d9f', part: "suffix", class: "breadcrumb-item__suffix" }, h("slot", { key: '9b91ec3388e2df5881fc4fc83c9ac9ae4b0e0cd7', name: "suffix", onSlotchange: () => this.handleSlotChange() })), h("span", { key: 'c51051586470e8ddf5ffeb45cde8a9755100acfa', part: "separator", class: "breadcrumb-item__separator", "aria-hidden": "true" }, h("slot", { key: '07f352eeb0d3891004b8b7500192178cd77f51f8', name: "separator", onSlotchange: () => this.handleSlotChange() }, h("sc-icon", { key: 'f335af9fbf60cca4033ff641a87073c86407862a', name: "chevron-right" })))));
    }
