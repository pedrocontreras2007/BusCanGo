...
const ScPaystackAddMethod = class {
    ...
    render() {
        return (h(Host, { key: '3debdd31dbf8e4bf402d7d4d18384b6b514a99bd' }, this.error && (h("sc-alert", { key: 'f3e2d721310b87387d96ff50eb3edd2b5897f9c7', open: !!this.error, type: "danger" }, h("span", { key: '79dfed2ffafaa66f817a281867d2d328f3a054d9', slot: "title" }, wp.i18n.__('Error', 'surecart')), this.error)), h("div", { key: 'ba3f069c91b5fabfe6a86cbdef326b2d018609ac', class: "sc-paystack-button-container" }, h("sc-alert", { key: 'f316aef141ab9ea070a8094a712ce0810cb18c6e', open: true, type: "warning" }, wp.i18n.__('In order to add a new card, we will need to make a small transaction to authenticate it. This is for authentication purposes and will be immediately refunded.', 'surecart'), h("div", { key: 'd09ec3b1303a2a5b7e6937565de7278e52d273e5' }, h("sc-button", { key: 'b555ed02b8f85004907382d75e9680e9a3ea0e67', loading: this.loading, type: "primary", onClick: () => this.createPaymentIntent(), style: { marginTop: 'var(--sc-spacing-medium)' } }, wp.i18n.__('Add New Card', 'surecart')))))));
    }
