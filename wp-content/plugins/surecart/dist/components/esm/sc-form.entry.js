...
const ScForm = class {
    ...
    render() {
        return (h("div", { key: 'd3117f4821a3ab6a947b22ba2e08609cc72b3198', part: "base", class: "form", role: "form" }, h("form", { key: '8bf710a0d232646a2a177caea56b021a9dd80afa', part: "form", ref: el => (this.formElement = el), class: "test", onSubmit: async (e) => {
                e.preventDefault();
            ...
            }, novalidate: this.novalidate }, h("slot", { key: '379beaa36b00f5a1a472cdfca3484198387ef043' }))));
    }
