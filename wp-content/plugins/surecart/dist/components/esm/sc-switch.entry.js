...
const ScSwitch = class {
    ...
    render() {
        ...
        return (h(Tag, { key: 'c5f89880b148cbdb90a95439a95aa92bcef46ca8', part: "base", htmlFor: this.switchId, class: {
                'switch': true,
            ...
            }, onMouseDown: e => this.handleMouseDown(e) }, h("span", { key: 'bc5a14dcc40faac42d9b23cb92fbc3df1e3d0628', part: "control", class: "switch__control" }, h("span", { key: 'db05fb48051d149e7c5f3d636a1a0e10bb9745f5', part: "thumb", class: "switch__thumb" }), h("input", { key: '908324f90c0191206fe20e3402adce7deabac67d', ref: el => (this.input = el), id: this.switchId, type: "checkbox", role: "switch", name: this.name, value: this.value || 'on', checked: this.checked, disabled: this.disabled, required: this.required, "aria-checked": this.checked ? 'true' : 'false', "aria-labelledby": this.labelId, onClick: () => this.handleClick(), onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus(), onKeyDown: e => this.handleKeyDown(e) })), h("span", { key: 'c69657c6ee99d02eb2f788d9816df7780832cf81', class: "switch__label" }, h("span", { key: '70396455c94e4aaf8d4e32e3ddb4899cf3529c60', part: "title", id: this.labelId, class: "switch__title" }, h("slot", { key: 'f68fc3032fe5b85dd334308fe05aa15552c7906a' })), h("span", { key: '2a469f168b0cc81b462b777456394774eb29a1ea', class: "switch__description", part: "description" }, h("slot", { key: 'a3285ce31ad48a330f87f77cf0664f30890325d6', name: "description" })))));
    }
