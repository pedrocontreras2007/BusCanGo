...
const ScProductLineItem = class {
    ...
    render() {
        var _a, _b;
        return (h("div", { key: '3d7c7409319e1f110efa7a115d28481c0617ad6c', class: "base", part: "base" }, h("div", { key: '940603baadf97cfafcf4a63981fcbe20ef507802', part: "product-line-item", class: {
                'item': true,
...
const ScQuantitySelect = class {
    ...
    render() {
        return (h("div", { key: '8c920cda4bd9b49b766b18b77f91332db117c8be', part: "base", class: {
                'quantity': true,
                // States
            ...
            } }, h("button", { key: '378d6b47125312f27995c9b04c3e54ea5eb29162', part: "minus", "aria-label": wp.i18n.__('Decrease quantity by one.', 'surecart'), "aria-disabled": this.disabled || (this.quantity <= this.min && this.min > 1), class: { 'button__decrease': true, 'button--disabled': this.quantity <= this.min && this.min > 1 }, onClick: () => this.quantity > this.min && this.decrease(), disabled: this.disabled || (this.quantity <= this.min && this.min > 1) }, h("sc-icon", { key: '65a3a9a3b91363aa887f25df079195ae3e74847d', name: "minus", exportparts: "base:minus__icon" })), h("input", { key: '2c7ed4e49f28007b48cca72dc354dff8c1fcd6e8', part: "input", class: "input__control", ref: el => (this.input = el), step: "1", type: "number", max: this.max, min: this.min, value: this.quantity, disabled: this.disabled, autocomplete: "off", role: "spinbutton", "aria-valuemax": this.max, "aria-valuemin": this.min, "aria-valuenow": this.quantity, "aria-disabled": this.disabled, onChange: () => this.handleChange(), onInput: () => this.handleInput(), onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur() }), h("button", { key: 'adf38b5c8049936e2cbf14ca8f98ff404a8324cc', part: "plus", "aria-label": wp.i18n.__('Increase quantity by one.', 'surecart'), class: { 'button__increase': true, 'button--disabled': this.quantity >= this.max }, onClick: () => this.quantity < this.max && this.increase(), "aria-disabled": this.disabled || this.quantity >= this.max, disabled: this.disabled || this.quantity >= this.max }, h("sc-icon", { key: 'c68b6d4da1cbc2ecf7a56919580149f934503170', name: "plus", exportparts: "base:plus__icon" }))));
    }
    get el() { return getElement(this); }
};
