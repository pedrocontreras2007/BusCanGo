...
const ScMenuLabel = class {
    ...
    render() {
        return (h("div", { key: 'e1c80d0c3268929e0a3a76139e0812ff62f625a5', part: "base", class: "menu-label" }, h("slot", { key: 'ac88b266cde98759f6cf8156b86fde385de50108' })));
    }
};
...
const ScSelectDropdown = class {
    ...
    render() {
        var _a;
        return (h("div", { key: '8a0a86190a33d43661fce46721263effa9bdae35', part: "base", class: {
                'select': true,
            ...
            } }, h("sc-form-control", { key: 'e2c90cf6a4d3b83ffe4d3f9eeb9ac1173d85a2d2', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, h("input", { key: 'db59f375e4e1d761e343b6539cce0a490fccca8f', class: "select__hidden-input", name: this.name, ref: el => (this.input = el), value: this.value, required: this.required, disabled: this.disabled, "aria-hidden": "true", "aria-label": this.displayValue() || this.label || this.placeholder, onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus() }), h("sc-dropdown", { key: '8a112d34acb77f234a83aead13c52e18ab28c316', exportparts: "trigger, panel", disabled: this.disabled, open: this.open, closeOnSelect: this.closeOnSelect, position: this.position, placement: this.placement, hoist: this.hoist, style: { '--panel-width': '100%' }, onScShow: () => this.handleShow(), onScHide: () => this.handleHide(), role: "select", "aria-open": this.open ? 'true' : 'false' }, h("slot", { key: 'd739147043741554f88a25c658f52bc6207044a6', name: "trigger", slot: "trigger" }, h("div", { key: 'c619a3fbfe8702c5964e645d142418d5496f20e9', class: "trigger", role: "button", tabIndex: -1, onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur() }, h("div", { key: '9602581c99d6d258ce935922d9f9aa46288471e6', class: "select__value" }, h("slot", { key: '8c7e0864001ddaecd4bc1a65b1119ac0ad169a30' }, this.displayValue() || this.placeholder || wp.i18n.__('Select...', 'surecart'))), h("sc-icon", { key: '81c08ede18555f83d49d74f50f5aaee3cc7bce00', exportparts: "base:caret", class: "select__caret", name: "chevron-down" }))), this.search && (h("sc-input", { key: 'e5975bd42c8e5e68e830b78912c6ce024bea80e9', exportparts: "base:search__base, input:search__input, form-control:search__form-control", placeholder: this.searchPlaceholder || wp.i18n.__('Search...', 'surecart'), onScInput: e => this.handleQuery(e), class: "search", clearable: true, part: "search", value: this.searchTerm, ref: el => (this.searchInput = el), "aria-label": wp.i18n.__('Type to search', 'surecart'), onKeyDown: e => e.stopPropagation() }, this.loading && h("sc-spinner", { key: '4f93ac498db9cd7a76af9057b1c4effc54277a14', exportparts: "base:spinner__base", style: { '--spinner-size': '0.5em' }, slot: "suffix" }))), h("sc-menu", { key: 'b92501c13cc0dd0a1648c27f76057d8a7feb2545', style: { maxHeight: '210px', overflow: 'auto' }, exportparts: "base:menu__base", onScroll: e => this.handleMenuScroll(e), "aria-multiselectable": "false" }, h("slot", { key: '40c8f56b498af3210eee0b0b9c30560568b16e4b', name: "prefix" }), (this.filteredChoices || []).map((choice, index) => {
            return [this.renderItem(choice, index), (choice.choices || []).map(choice => this.renderItem(choice, index))];
        }), this.loading && (h("div", { key: 'fec5e1be1094a5d0d71e6e8a0909ba6dc7ba0d61', class: "loading" }, h("sc-spinner", { key: '0af4150810b90a3d687995178d096a36dded2ae1', exportparts: "base:spinner__base" }))), !this.loading && !this.filteredChoices.length && (h("div", { key: '03eac5763288edf1588138a78a9c7e3ff4a56948', class: "select__empty", part: "empty" }, wp.i18n.__('Nothing Found', 'surecart'))), h("slot", { key: '5b58f5c6b624db90860747a88766eb55858faf8b', name: "suffix" }))))));
    }
