...
const ScCancelDiscount = class {
    ...
    render() {
        ...
        return (h("div", { key: '28bb50673a6fdd31c7b5f0c74a8dbde9d3bae01c', class: "cancel-discount" }, h("sc-dashboard-module", { key: 'b28424b35bb1ea5dff55d03815dbea3e641a78ad', heading: title, style: { '--sc-dashboard-module-spacing': '2em' } }, h("span", { key: '31b6d2acab58febf2fa6ff2b14eee3f8b6724f4d', slot: "description" }, description), h("sc-flex", { key: '6f7998ee55b9989c7c4b193681b190c67ab21380', justifyContent: "flex-start" }, h("sc-button", { key: '671fcd0a50fdbba1a49d888cf021df3397a3704b', type: "primary", onClick: () => this.addDiscount() }, button), h("sc-button", { key: 'fbe8d0cd72148b9fda2ebc3b2b2e7584013c3aa0', class: "cancel-discount__abort-link", type: "text", onClick: () => this.scCancel.emit() }, cancel_link)), !!this.loading && h("sc-block-ui", { key: 'f90f8b6f7232168b8e1d5ebcac47f796f9270834', spinner: true }))));
    }
};
...
const ScSubscriptionCancel = class {
    ...
    render() {
        return (h("sc-dashboard-module", { key: 'd7621e7dd2d10df1fea06b75a60f7ac4a0c49089', heading: this.heading || wp.i18n.__('Cancel your plan', 'surecart'), class: "subscription-cancel", error: this.error, style: { '--sc-dashboard-module-spacing': '1em' } }, this.renderContent(), h("sc-flex", { key: '339c8593e7a9093edb0ea73cbc2461d0eb3d44cf', justifyContent: "flex-start" }, h("sc-button", { key: 'c4a60a40357e09a76a81290541f06a2b279044b5', type: "primary", loading: this.loading || this.busy, disabled: this.loading || this.busy, onClick: () => this.cancelSubscription() }, wp.i18n.__('Cancel Plan', 'surecart')), h("sc-button", { key: '648156bdc848bbac1b2d30a255f3f2e3428d68a7', style: { color: 'var(--sc-color-gray-500' }, type: "text", onClick: () => this.scAbandon.emit(), loading: this.loading || this.busy, disabled: this.loading || this.busy }, wp.i18n.__('Keep My Plan', 'surecart'))), this.busy && h("sc-block-ui", { key: '4b35166c408a9811286c7eeb7cccb73a25e3f6bc' })));
    }
};
...
const ScTextarea = class {
    ...
    render() {
        return (h("div", { key: '729da55b5b819c3d9f0e6dd19895517389487cfd', part: "form-control", class: {
                'form-control': true,
                'form-control--small': this.size === 'small',
                'form-control--medium': this.size === 'medium',
                'form-control--large': this.size === 'large',
            } }, h("sc-form-control", { key: '82279408e8aea3138414bf070e3aea89dd8d7286', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, h("div", { key: 'fe13ebb577f85e61bba08d6da4101f84d1e29278', part: "form-control-input", class: "form-control-input" }, h("div", { key: 'f6ffebd399cc182a648dd586f3e082ce7a9325cd', part: "base", class: {
                'textarea': true,
            ...
            } }, h("textarea", { key: '342a8c64e9e7500e3655221de8fa204451beaf78', part: "textarea", ref: el => (this.input = el), id: "input", class: "textarea__control", name: this.name, value: this.value, disabled: this.disabled, readonly: this.readonly, required: this.required, placeholder: this.placeholder, rows: this.rows, minlength: this.minlength, maxlength: this.maxlength, autocapitalize: this.autocapitalize, autocorrect: this.autocorrect, autofocus: this.autofocus, spellcheck: this.spellcheck, enterkeyhint: this.enterkeyhint, inputmode: this.inputmode, "aria-describedby": "help-text", onChange: () => this.handleChange(), onInput: () => this.handleInput(), onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur(), onKeyDown: (e) => e.stopPropagation() })), this.showCharLimit && (h("div", { key: 'a29328dfb9160054bfc6abcd1796f52abaf87669', slot: "help", class: 'textarea__char-limit-warning' }, wp.i18n.sprintf(wp.i18n.__('%d characters remaining', 'surecart'), this.maxlength - this.input.value.length)))))));
    }
