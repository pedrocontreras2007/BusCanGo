...
import { a as availableProcessors } from './getters-01ae99ba.js';
import { c as createErrorNotice } from './mutations-ed6d0770.js';
import { u as updateFormState } from './mutations-98df238e.js';
...
const ScStripeElement = class {
    ...
    render() {
        return (h(Fragment, { key: '25a4e66d89d463d1dffa1647aba57c4465ae44b5' }, h("sc-form-control", { key: '387c3557d2d92009a73b24a73b082d1b51c765cc', class: "sc-stripe", size: this.size, label: this.label }, h("div", { key: '87491abaf03e116626916dd1970fdab36e1be3a7', class: "sc-stripe-element", ref: el => (this.container = el) })), this.error && (h("sc-text", { key: '5cbf5941ced119af8a8f0997e7503deeef44430d', style: {
