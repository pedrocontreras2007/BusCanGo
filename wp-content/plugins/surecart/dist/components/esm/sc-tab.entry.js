...
const ScTab = class {
    ...
    render() {
        ...
        return (h(Tag, { key: '8d2c745289f7f1eca46bcd903d5be5b0e0300f40', part: `base ${this.active ? `active` : ``}`, href: this.href, class: {
                'tab': true,
