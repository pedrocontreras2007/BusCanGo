...
const ScLogin = class {
    ...
    render() {
        var _a, _b;
        return (h("div", { key: 'a198dd3dd85a3fd53b499d6f01fc225b1e9886d8', class: "login-form" }, h("sc-card", { key: 'dc34f52874910e41dd8b46af1d512c8d5166cd50' }, !!this.error && (h("sc-alert", { key: 'a63a28c99a041e9d61fd0cfc7e331537426c5ede', open: true, type: "danger", closable: true, onScHide: () => (this.error = null) }, h("span", { key: '293bb57f85b4f50fb728be0d559148286f0ba8fb', slot: "title", innerHTML: (_a = this.error) === null || _a === void 0 ? void 0 : _a.message }), (((_b = this.error) === null || _b === void 0 ? void 0 : _b.additional_errors) || []).map(({ message }) => (h("div", { innerHTML: message }))))), this.renderInner()), this.loading && h("sc-block-ui", { key: '2f0926e300c1f8d68c5eb444583a98ef593580d8', spinner: true, style: { 'zIndex': '9', '--sc-block-ui-opacity': '0.5' } })));
    }
