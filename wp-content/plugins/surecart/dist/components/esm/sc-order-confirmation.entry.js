...
const ScOrderConfirmation = class {
    ...
    render() {
        var _a, _b;
        return (h(Universe.Provider, { key: '2542268e6cd746665a943acef3e3f261f6c4c491', state: this.state() }, h("div", { key: 'ed68a39164484e4d3d98c036ea0c5d761e762765', class: { 'order-confirmation': true } }, h("div", { key: '4bbb7dbff74f58cd94b20e981c96c6d6ec6ee39a', class: {
                'order-confirmation__content': true,
                'hidden': !((_a = this.order) === null || _a === void 0 ? void 0 : _a.id) && !this.loading,
            } }, h("sc-order-confirm-components-validator", { key: '86a891bb079f69a97733755550a8fa3306e22695', checkout: this.order }, h("slot", { key: 'ceb66ccf3fa68537960dbf49cc584695a933a5b4' }))), !((_b = this.order) === null || _b === void 0 ? void 0 : _b.id) && !this.loading && (h("sc-heading", { key: '13b14cc1bc442588a169aeadcdee6c2c7f1fc150' }, wp.i18n.__('Order not found.', 'surecart'), h("span", { key: 'bf4826727c0c0fe4704d1bc707147321e82a5ea2', slot: "description" }, wp.i18n.__('This order could not be found. Please try again.', 'surecart')))))));
    }
};
