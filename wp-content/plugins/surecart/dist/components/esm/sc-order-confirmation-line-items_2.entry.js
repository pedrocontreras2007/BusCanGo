...
const ScOrderConfirmationTotals = class {
    ...
    render() {
        ...
        return (h("div", { key: 'fc8510722fcc903892fa759dde1feb2446e82836', class: { 'line-item-totals': true } }, h("sc-line-item-total", { key: 'f8a9dc4a177acbf68fbcbc466f0829c8947e599c', checkout: this.order, total: "subtotal" }, h("span", { key: 'd801a7c14634c4c1ba3df0d85629eddd96a9b374', slot: "description" }, wp.i18n.__('Subtotal', 'surecart'))), this.renderDiscountLine(), !!((_a = this.order) === null || _a === void 0 ? void 0 : _a.bump_amount) && (h("sc-line-item", { key: '55528e5fafbc63567559550951a6e75b803b0406', style: { marginTop: 'var(--sc-spacing-small)' } }, h("span", { key: '9c200668fee9817f9e7188068d77a172c85605bc', slot: "description" }, wp.i18n.__('Bundle Discount', 'surecart')), h("sc-format-number", { key: '589136971ecb1b53057dd6584676cc0b2dd40e90', slot: "price", type: "currency", currency: (_b = this.order) === null || _b === void 0 ? void 0 : _b.currency, value: (_c = this.order) === null || _c === void 0 ? void 0 : _c.bump_amount }))), !!((_d = this.order) === null || _d === void 0 ? void 0 : _d.shipping_amount) && (h("sc-line-item", { key: 'e6ed1e6f59b7654bc377b929cf29c7ae88c508d3', style: { marginTop: 'var(--sc-spacing-small)' } }, h("span", { key: 'f4aac57c2df848bfa8645bfb3dbe8b2cf6ab08e6', slot: "description" }, wp.i18n.__('Shipping', 'surecart')), h("sc-format-number", { key: '54d8ceb460b94a487cff21b61e550c04344364ab', slot: "price", type: "currency", currency: (_e = this.order) === null || _e === void 0 ? void 0 : _e.currency, value: (_f = this.order) === null || _f === void 0 ? void 0 : _f.shipping_amount }))), !!((_g = this.order) === null || _g === void 0 ? void 0 : _g.tax_amount) && (h("sc-line-item", { key: '42a819f26337ab060039dcaaced46e253d7880ec', style: { marginTop: 'var(--sc-spacing-small)' } }, h("span", { key: '2afbb951e888e1a6646b8ea1c18c3bcd888f9b95', slot: "description" }, formatTaxDisplay((_h = this.order) === null || _h === void 0 ? void 0 : _h.tax_label), " ", `(${this.order.tax_percent}%)`), h("sc-format-number", { key: 'c4d90e0d28f12afe7e423802f26e7405595b7aa1', slot: "price", type: "currency", currency: (_j = this.order) === null || _j === void 0 ? void 0 : _j.currency, value: (_k = this.order) === null || _k === void 0 ? void 0 : _k.tax_amount }))), h("sc-divider", { key: 'ec0cb77bdfb257893a6f62042e80c95fb0be2979', style: { '--spacing': 'var(--sc-spacing-small)' } }), h("sc-line-item-total", { key: 'e2ba10c9f6cfb8530c7eefb7f7fdc2aa6edb28eb', checkout: this.order, size: "large", "show-currency": true }, h("span", { key: 'c21dea207ce125eee3e3559bda63fda81de30a43', slot: "description" }, wp.i18n.__('Total', 'surecart')))));
    }
};
