...
const ScSubscriptionDetails = class {
    ...
    render() {
        return (h("div", { key: '5489791eb6c85eff31643decfad2095c5d589b47', class: "subscription-details" }, this.hasPendingUpdate && (h("div", { key: 'b8b296de4d485af8631d3b2c84fa35d6c8db5e62' }, h("sc-tag", { key: 'cf9561bdc8be63306120fa9dec6fc8228ec95ad8', size: "small", type: "warning" }, wp.i18n.__('Update Scheduled', 'surecart')))), h("sc-flex", { key: '561940da92520d098a55ef7f0cd58fa33d900f54', alignItems: "center", justifyContent: "flex-start" }, h("sc-text", { key: '37f84bfd3e2a0c7b7cbeb8d4ff6d58699a81a6bd', "aria-label": wp.i18n.sprintf(wp.i18n.__('Plan name - %s', 'surecart'), this.renderName()), style: { '--font-weight': 'var(--sc-font-weight-bold)' } }, this.renderName()), this.renderActivations()), !this.hideRenewalText && h("div", { key: '441d36a82787b20d9d7e68e4e52a92276aab9300' }, this.renderRenewalText(), " "), h("slot", { key: 'f1ee8e09966e58dbed98c636022255473395183a' }), h("sc-dialog", { key: '6d99e88f6570148c3558fd07ec91e40c17a9e606', label: wp.i18n.__('Activations', 'surecart'), onScRequestClose: () => (this.activationsModal = false), open: !!this.activationsModal }, h("sc-card", { key: '9487d0d86c5a6a7e7d5be718264c4cb4df2c4138', "no-padding": true, style: { '--overflow': 'hidden' } }, h("sc-stacked-list", { key: 'af80104013dfeba4be209a86111d1e33e5b0a2a1' }, (this.getActivations() || []).map(activation => {
...
const ScSubscriptionStatusBadge = class {
    ...
    render() {
        return (h("sc-tag", { key: '18242a6f1f4444ae4badbc4885ae5c6d9d6053a4', "aria-label": wp.i18n.sprintf(wp.i18n.__('Plan Status - %s', 'surecart'), this.getText()), type: this.getType() }, this.getText()));
    }
};
