...
const ScChoice = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7012d62fda41a94ef786be280dba18ff87ec1edf', tabindex: "0", onFocus: () => this.input.focus() }, index.h("div", { key: '93f49fe71c41e00d95914f3d96e3ffa47ca21585', part: "base", class: {
                'choice': true,
            ...
            }, onKeyDown: e => this.handleKeyDown(e), onMouseDown: e => this.handleMouseDown(e) }, index.h("slot", { key: '2f5b1ef56017cd8b651d4581e872058469416686', name: "header" }), index.h("label", { key: '81d821cf890ad817ff4ee3e91679999286249837', class: "choice__content", part: "content", htmlFor: this.inputId }, index.h("span", { key: '90cfb773a319daad865da7d0af07d978ab6b67cb', part: "control", class: {
                choice__control: true,
                choice__checkbox: this.type === 'checkbox',
                choice__radio: this.type === 'radio',
            }, hidden: !this.showControl }, index.h("span", { key: '5ba4b439529036545dba51555c18047c8b8ae240', part: "checked-icon", class: "choice__icon" }, this.type === 'checkbox' ? (index.h("svg", { viewBox: "0 0 16 16" }, index.h("g", { stroke: "none", "stroke-width": "1", fill: "none", "fill-rule": "evenodd", "stroke-linecap": "round" }, index.h("g", { stroke: "currentColor", "stroke-width": "2" }, index.h("g", { transform: "translate(3.428571, 3.428571)" }, index.h("path", { d: "M0,5.71428571 L3.42857143,9.14285714" }), index.h("path", { d: "M9.14285714,0 L3.42857143,9.14285714" })))))) : (index.h("svg", { viewBox: "0 0 16 16" }, index.h("g", { stroke: "none", "stroke-width": "1", fill: "none", "fill-rule": "evenodd" }, index.h("g", { fill: "currentColor" }, index.h("circle", { cx: "8", cy: "8", r: "3.42857143" })))))), index.h("input", { key: '9fdc70a6773c8f581e821d7a7fac3cf4a536f75c', id: this.inputId, ref: el => (this.input = el), type: this.type, name: this.name, value: this.value, checked: this.checked, disabled: this.disabled, "aria-checked": this.checked ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false', "aria-labelledby": this.labelId, tabindex: "0",
            // required={this.required}
            onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus(), onChange: () => this.handleClickEvent() })), index.h("span", { key: '6bfba4e4cb347cccff091aa78259ed842391f76d', part: "label", id: this.labelId, class: "choice__label" }, index.h("span", { key: '7f0d2068b0b4807f9c13821ceac566d96ebbb1f0', class: "choice__label-text", hidden: !this.showLabel }, index.h("span", { key: 'd1842e3c1f6ae1a9387436dea1d23adb6b2907bb', class: "choice__title", part: "title" }, index.h("slot", { key: '7877222dd719a68e6e94dea0c8b9bc4226da35a2', onSlotchange: () => this.handleSlotChange() })), index.h("span", { key: 'da8328254dc7321c7173a99f8a8d6c4751e76207', class: "choice__description description", part: "description", hidden: !this.hasDescription }, index.h("slot", { key: '3c3f8a67c0a3c9239542cc9b2662a818119754da', name: "description", onSlotchange: () => this.handleSlotChange() }))), index.h("span", { key: '045100492145fab3485a1851c4a845de098dc7f3', class: "choice__price", hidden: !this.showPrice || (!this.hasPrice && !this.hasPer) }, index.h("span", { key: '9679ee533764332305d1c8520e98262707042469', class: "choice__title" }, index.h("slot", { key: '326e67d5dcf3d47be9776b1769be01e308e468db', name: "price", onSlotchange: () => this.handleSlotChange() })), ' ', index.h("span", { key: 'd55fdfb884176859017b1c4ea7d3730f107acb6b', class: "choice__description" }, index.h("slot", { key: '2e631740e271206e8190c123c2bf762fb6994987', name: "per", onSlotchange: () => this.handleSlotChange() }))))), index.h("slot", { key: '70c4ae184bbcac1d1c9bb98af01354617189661d', name: "footer" }))));
    }
