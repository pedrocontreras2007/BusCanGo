...
const ScPassword = class {
    ...
    render() {
        var _a;
        return (index.h("div", { key: '23719f49cc9fc8ba8185f9b873bbe4fe9444ef70', class: "password" }, index.h("div", { key: '1f84bfb64b05553eef03997ef7e21ec746818e07' }, index.h("sc-input", { key: '1cec6d6f3007db0197fb5e8c61a223c77503d6f8', ref: el => (this.input = el), label: this.label, help: this.help, autofocus: this.autofocus, placeholder: this.placeholder, showLabel: this.showLabel, size: this.size ? this.size : 'medium', type: "password", name: "password", value: this.value, required: this.required, disabled: this.disabled, onScInput: () => this.handleValidate() }), !!this.hintText && index.h("small", { key: '6f605578551e81e9a4b8d39497c9259310df441a', class: "password__hint" }, this.hintText)), this.confirmation && (index.h("div", { key: '53fb988f414f332876dfe9222ddf1053b8c50749' }, index.h("sc-input", { key: 'f24427711e0d25a9a227dcaa08cc290377547d5e', ref: el => (this.confirmInput = el), label: (_a = this.confirmationLabel) !== null && _a !== void 0 ? _a : wp.i18n.__('Confirm Password', 'surecart'), help: this.confirmationHelp, placeholder: this.confirmationPlaceholder, size: this.size ? this.size : 'medium', type: "password", value: this.value, onScInput: () => this.handleVerification(), required: this.required, disabled: this.disabled }), !!this.verifyText && index.h("small", { key: 'c4316d9274f6e8fef223e8666f5262355897e4d6', class: "password__hint" }, this.verifyText)))));
    }
