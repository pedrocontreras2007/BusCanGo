...
const ScSubscriptionPayment = class {
    ...
    render() {
        return (index.h("sc-dashboard-module", { key: '6a62f1fd798d5415f366653d7f6c2ac89be9f542', heading: wp.i18n.__('Select a payment method', 'surecart'), class: "subscription-payment", error: this.error }, index.h("sc-form", { key: '05efb90ab9fc88e12ffa30a93fd2de7d76773b22', onScFormSubmit: e => this.handleSubmit(e) }, index.h("sc-card", { key: '40a16136ab8c0dcf5eeb013be46669b2e64659f7' }, this.renderContent())), this.busy && index.h("sc-block-ui", { key: '5d2180c526313a6118db101e99ae1368b21723a3' })));
    }
};
