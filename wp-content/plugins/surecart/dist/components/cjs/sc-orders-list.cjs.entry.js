...
const ScOrdersList = class {
    ...
    render() {
        var _a, _b;
        return (index.h("sc-dashboard-module", { key: '17c0477670410dae0c10fdd2a787c9a46318d7b4', class: "orders-list", error: this.error }, index.h("span", { key: 'd6c7d50da7495dc11dd7f9f0c3fb9a2bea6e92de', slot: "heading" }, index.h("slot", { key: 'dad777fc92668de717a7088d8c95892834c5503c', name: "heading" }, this.heading || wp.i18n.__('Order History', 'surecart'))), !!this.allLink && !!((_a = this.orders) === null || _a === void 0 ? void 0 : _a.length) && (index.h("sc-button", { key: 'c8d0e8d35290f40257022e917b91ff6fed074909', type: "link", href: this.allLink, slot: "end", "aria-label": wp.i18n.sprintf(wp.i18n.__('View all %s', 'surecart'), this.heading || wp.i18n.__('Order History', 'surecart')) }, wp.i18n.__('View all', 'surecart'), index.h("sc-icon", { key: 'bca7d2aab7a7296b13f9b44d94516d24f7a8bfad', "aria-hidden": "true", name: "chevron-right", slot: "suffix" }))), this.renderContent(), !this.allLink && (index.h("sc-pagination", { key: '420c3f541b43b5a2141aedce5fc84d4fe164f6a3', page: this.query.page, perPage: this.query.per_page, total: this.pagination.total, totalPages: this.pagination.total_pages, totalShowing: (_b = this === null || this === void 0 ? void 0 : this.orders) === null || _b === void 0 ? void 0 : _b.length, onScNextPage: () => this.nextPage(), onScPrevPage: () => this.prevPage() })), this.busy && index.h("sc-block-ui", { key: 'ad6d4082e36772edb244e48a907f22d4b358e62a' })));
    }
