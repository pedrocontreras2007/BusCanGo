...
const ScLicensesList = class {
    ...
    render() {
        var _a;
        return (index.h("sc-dashboard-module", { key: '1d4ae3e00f70151c1a676fe70e948a14139e5626', class: "purchase", part: "base", error: this.error }, index.h("span", { key: 'af8653ec0d7fb872f0e9c397699d0b5a416c30db', slot: "heading" }, index.h("slot", { key: '61374cf147cc0f30b239c4e9080e7105934c8563', name: "heading" }, this.heading || wp.i18n.__('License Keys', 'surecart'))), !!this.allLink && !!((_a = this.licenses) === null || _a === void 0 ? void 0 : _a.length) && (index.h("sc-button", { key: '8fe7267c9c84d3822bab7e9987c9548c0c175ac1', type: "link", href: this.allLink, slot: "end" }, wp.i18n.__('View all', 'surecart'), index.h("sc-icon", { key: '4a97b208eaf3608c5d4839831e3300e2f99a6f48', name: "chevron-right", slot: "suffix" }))), this.renderContent()));
    }
