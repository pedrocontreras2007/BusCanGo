...
const ScCustomerDetails = class {
    ...
    render() {
        var _a, _b, _c;
        return (index.h("sc-dashboard-module", { key: '23e8f91bd6bb6b7c2d6e0fe505eeafcbea213a71', exportparts: "base, heading, heading-text, heading-title, heading-description", class: "customer-details", error: this.error }, index.h("span", { key: '53bb442e899f808e5f15ca87bdc805fa364ed856', slot: "heading" }, this.heading || wp.i18n.__('Billing Details', 'surecart'), ' ', !!((_a = this === null || this === void 0 ? void 0 : this.customer) === null || _a === void 0 ? void 0 : _a.id) && !((_b = this === null || this === void 0 ? void 0 : this.customer) === null || _b === void 0 ? void 0 : _b.live_mode) && (index.h("sc-tag", { key: '92efdf7482cfb066e8ac59c80150c4f938e735ba', exportparts: "base:test-tag__base, content:test-tag__content", type: "warning", size: "small" }, wp.i18n.__('Test', 'surecart')))), !!this.editLink && !!((_c = this.customer) === null || _c === void 0 ? void 0 : _c.id) && (index.h("sc-button", { key: '3fb0662b1cecd7f862fea38080ef4d007978bcca', exportparts: "base:button__base, label:button__label, prefix:button__prefix", type: "link", href: this.editLink, slot: "end" }, index.h("sc-icon", { key: '70f37eb65cbc19cacf690ae58157850ac77556cd', name: "edit-3", slot: "prefix" }), wp.i18n.__('Update', 'surecart'))), this.renderContent()));
    }
