...
const ScHeading = class {
    ...
    render() {
        return (index.h("div", { key: '5c4f4a709283b693c9b1ed65fb9225c7941b01c5', part: "base", class: {
                'heading': true,
                'heading--small': this.size === 'small',
                'heading--medium': this.size === 'medium',
                'heading--large': this.size === 'large',
            } }, index.h("div", { key: 'a7cba0a1e0bf66c6b051437fd5e60cfc72523b24', class: { heading__text: true } }, index.h("div", { key: '57608f378899490eb0102dcb302714ed9cd0880f', class: "heading__title", part: "title" }, index.h("slot", { key: '16ab29024968653c888832b2931b9730740028d7' })), index.h("div", { key: 'b43f7c65bc9869afdf864e2f67e958cbdca94695', class: "heading__description", part: "description" }, index.h("slot", { key: 'ed06ac76e974ed5fe888be883806da8351d881f8', name: "description" }))), index.h("slot", { key: '0294ab027665f0d4d2fe14aa1ba4a27f0ff4d658', name: "end" })));
    }
...
const ScOrderConfirmComponentsValidator = class {
    ...
    render() {
        return index.h("slot", { key: 'c3f3d18b827fd9e7b8ec07e28b88fb2462892f62' });
    }
    get el() { return index.getElement(this); }
