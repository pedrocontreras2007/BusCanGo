...
const ScSubscriptionsList = class {
    ...
    render() {
        var _a, _b;
        return (index.h("sc-dashboard-module", { key: '81de7b95d9f4ab5c830fb9e0c673a88076e3b015', class: "subscriptions-list", error: this.error }, index.h("span", { key: 'ba3f773763c41bf5e6261b8d9f3bc22b86cfc5ae', slot: "heading" }, index.h("slot", { key: '135899600ca146d726a633f25bfa90a8ce5005c2', name: "heading" }, this.heading || wp.i18n.__('Subscriptions', 'surecart'))), !!this.allLink && !!((_a = this.subscriptions) === null || _a === void 0 ? void 0 : _a.length) && (index.h("sc-button", { key: '69edda3623ed5e1a2987a588e3b011a11d07eb24', type: "link", href: this.allLink, slot: "end", "aria-label": wp.i18n.sprintf(wp.i18n.__('View all %s', 'surecart'), this.heading || 'Subscriptions') }, wp.i18n.__('View all', 'surecart'), index.h("sc-icon", { key: '82fda599dd54362da39a778cd0da2803b0a293aa', "aria-hidden": "true", name: "chevron-right", slot: "suffix" }))), this.renderContent(), !this.allLink && (index.h("sc-pagination", { key: 'd7ba4cfd3d488ebbe4ddae60354ef7c71ba9cacd', page: this.query.page, perPage: this.query.per_page, total: this.pagination.total, totalPages: this.pagination.total_pages, totalShowing: (_b = this === null || this === void 0 ? void 0 : this.subscriptions) === null || _b === void 0 ? void 0 : _b.length, onScNextPage: () => this.nextPage(), onScPrevPage: () => this.prevPage() })), this.busy && index.h("sc-block-ui", { key: 'd1050f870635cd29ae9c0f2eee4b6551a5ed74d3' })));
    }
