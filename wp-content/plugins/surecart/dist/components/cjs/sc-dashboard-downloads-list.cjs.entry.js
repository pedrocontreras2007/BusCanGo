...
const ScDownloadsList = class {
    ...
    render() {
        var _a;
        return (index.h("sc-purchase-downloads-list", { key: '04e824264bde23af842200a6f2fa2390cfc5c04b', heading: this.heading, allLink: this.allLink && this.pagination.total_pages > 1 ? this.allLink : '', loading: this.loading, busy: this.busy, requestNonce: this.requestNonce, error: this.error, purchases: this.purchases }, index.h("span", { key: '6a643e3b1318c26a49ca1cd0def04a6d6b0805d0', slot: "heading" }, index.h("slot", { key: '4a694f4c99702075a5623724a85759ff7428e103', name: "heading" }, this.heading || wp.i18n.__('Downloads', 'surecart'))), index.h("sc-pagination", { key: '31e7c8727284485644e1823d8975d55d62e6f2e6', slot: "after", page: this.query.page, perPage: this.query.per_page, total: this.pagination.total, totalPages: this.pagination.total_pages, totalShowing: (_a = this === null || this === void 0 ? void 0 : this.purchases) === null || _a === void 0 ? void 0 : _a.length, onScNextPage: () => this.nextPage(), onScPrevPage: () => this.prevPage() })));
    }
