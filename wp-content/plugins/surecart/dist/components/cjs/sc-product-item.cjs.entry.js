...
const ScProductItem = class {
    ...
    render() {
        ...
        return (index.h("a", { key: '528f938805ce62f9385a0092086f1bdadd5dda0e', href: (_a = this.product) === null || _a === void 0 ? void 0 : _a.permalink, class: { 'product-item': true } }, this.product &&
