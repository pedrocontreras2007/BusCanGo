...
const ScInvoicesList = class {
    ...
    render() {
        var _a, _b;
        return (index.h("sc-dashboard-module", { key: '5992864f8144798dea426aeed406d33c0d6a1504', class: "invoices-list", error: this.error }, index.h("span", { key: '1256c1ff549e7de7af1b7c8de5ea33eaeb2fbfbd', slot: "heading" }, index.h("slot", { key: '180d32a25df5e4f8fb3e1da36fc724244a88ee47', name: "heading" }, this.heading || wp.i18n.__('Invoices', 'surecart'))), !!this.allLink && !!((_a = this.invoices) === null || _a === void 0 ? void 0 : _a.length) && (index.h("sc-button", { key: '7f58aac442ddaf2b6a1bcd36332198bfb4f9abd9', type: "link", href: this.allLink, slot: "end", "aria-label": wp.i18n.sprintf(wp.i18n.__('View all %s', 'surecart'), this.heading || wp.i18n.__('Invoices', 'surecart')) }, wp.i18n.__('View all', 'surecart'), index.h("sc-icon", { key: '337a05133a481b09519345e137091fc2fc678acf', "aria-hidden": "true", name: "chevron-right", slot: "suffix" }))), this.renderContent(), !this.allLink && (index.h("sc-pagination", { key: '493a39f3f8f07b746571d0f09d780ba090b654dc', page: this.query.page, perPage: this.query.per_page, total: this.pagination.total, totalPages: this.pagination.total_pages, totalShowing: (_b = this === null || this === void 0 ? void 0 : this.invoices) === null || _b === void 0 ? void 0 : _b.length, onScNextPage: () => this.nextPage(), onScPrevPage: () => this.prevPage() })), this.busy && index.h("sc-block-ui", { key: '7186dcaf461e1f5e442f231f70141009d630ad28' })));
    }
