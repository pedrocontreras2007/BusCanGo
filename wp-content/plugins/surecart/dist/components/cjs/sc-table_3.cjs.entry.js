...
const ScTable = class {
    ...
    render() {
        return (index.h(index.Host, { key: '77abe849e30b417320343f911384215194b2519d' }, index.h("slot", { key: '73e96aa63ce6d40270fd6cda333c7f37a85d0307', name: "head" }), index.h("slot", { key: 'd8e1d1c4321d46003c43f499311c59de0aaa9794' }), index.h("slot", { key: '509d4b5227b4a64eec3df2c4c92453cbd79c169b', name: "footer" })));
    }
};
...
const ScTableScll = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e528826ac8978c86a20785851a9d865ae5941d0d' }, index.h("slot", { key: '54f97df7fc7e94f472af13abb01866c09eaec790' })));
    }
};
...
const ScTableRow = class {
    ...
    render() {
        return (index.h(index.Host, { key: '91166738aca1ed7848f09905c3e53421d098d625' }, index.h("slot", { key: '48a365285358271a4b4e76105108f51fcf4d4ab7' })));
    }
};
