...
const ScFormControl = class {
    ...
    render() {
        return (index.h("div", { key: 'c9c208f999526fd99372cc5cabc934fef7de9eb2', part: "form-control", class: {
                'form-control': true,
            ...
            } }, index.h("label", { key: 'e8fe874d2a8f36a3531e3a3ad11361bbfd1ecf00', part: "label", id: this.labelId, class: "form-control__label", htmlFor: this.inputId, "aria-hidden": !!this.label ? 'false' : 'true' }, index.h("slot", { key: '7fb74943e796964f9c013246f25a38caa3192356', name: "label" }, this.label), index.h("slot", { key: '3d208285a35f584631e6152a6ef87538e1dd7120', name: "label-end" }), !!this.required && (index.h("span", { key: 'bd73d7f70b0f45c7a93d0fabba0fb5fa92f26c7c', "aria-hidden": "true", class: "required" }, ' ', "*")), index.h("sc-visually-hidden", { key: 'a46680afdac2fff9cab65b0b812f4b1e2ef615e1' }, !!this.required ? wp.i18n.__('required', 'surecart') : '')), index.h("div", { key: 'd77d32d09114bb21c93f1e2433a2ae562c4c14c9', part: "input", class: "form-control__input" }, index.h("slot", { key: '8c64364e5ac8c6b6a71ff508583b759c537516da' })), this.help && (index.h("div", { key: '7f482cb35ef7b3b47b9410f6d66db6b14e114892', part: "help-text", id: this.helpId, class: "form-control__help-text" }, index.h("slot", { key: 'baa833b9ae848573c5d25c074adf825047ad8457', name: "help-text" }, this.help)))));
    }
...
const ScInput = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '8a673666206e40eec341edf2bc46ad02a7c6dfdc', hidden: this.hidden }, index.h("sc-form-control", { key: '681a2139c405539da2369ad99c8669d170a63123', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, index.h("slot", { key: '09778a48b704dfff7dc69631345e27290b3652d5', name: "label-end", slot: "label-end" }), index.h("div", { key: '06e4cf9cdd83fe21ed8927e66aaef702d7af1dc5', part: "base", class: {
                'input': true,
                // Sizes
            ...
            } }, index.h("span", { key: '0472df603615afff08791a78ffaaa03113a8faa0', part: "prefix", class: "input__prefix" }, index.h("slot", { key: 'c9d8b031e2ce55807729499acfcfa5de4917cb91', name: "prefix" })), index.h("slot", { key: '02789ebdfc7ef005c8e07c3b77f702b5deda20ba' }, index.h("input", { key: 'a2100958e6ff04dd00ecf39de5744fcab77e2d9a', part: "input", id: this.inputId, class: "input__control", ref: el => (this.input = el), type: this.type === 'password' && this.isPasswordVisible ? 'text' : this.type, name: this.name, disabled: this.disabled, readonly: this.readonly, required: this.required, placeholder: this.placeholder, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step,
            ...
            } })), index.h("span", { key: '8ca593d03813ada4d6be253cd3dd1b90b86be8e8', part: "suffix", class: "input__suffix" }, index.h("slot", { key: '077b3125fa04becdc553b02318782ff4b678aba4', name: "suffix" })), this.clearable && ((_a = this.value) === null || _a === void 0 ? void 0 : _a.length) > 0 && (index.h("button", { key: '2a24870c5e6f31379aa7f4eb1306773f9527f9ca', part: "clear-button", class: "input__clear", type: "button", onClick: e => this.handleClearClick(e), tabindex: "-1" }, index.h("slot", { key: 'c451ba48a2b069f02208a3247c3ea4f259b7c72a', name: "clear-icon" }, index.h("svg", { key: 'f47d0aadc31ec82f9f48cd99786ba8765d71d1ff', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "feather feather-x" }, index.h("line", { key: '20cf8f518d3168fbeecb8082c39a5dd8f498030a', x1: "18", y1: "6", x2: "6", y2: "18" }), index.h("line", { key: '0fab8e752d56d3367470967158a98521f8950960', x1: "6", y1: "6", x2: "18", y2: "18" })))))))));
    }
    get el() { return index.getElement(this); }
