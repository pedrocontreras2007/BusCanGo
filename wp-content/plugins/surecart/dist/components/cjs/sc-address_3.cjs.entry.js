...
const ScCheckbox = class {
    ...
    render() {
        ...
        return (index.h(Tag, { key: 'dd6844e630a087b0c6503f4adc57c804bd0f79cc', part: "base", class: {
                'checkbox': true,
            ...
            }, htmlFor: this.inputId, onMouseDown: () => this.handleLabelMouseDown() }, index.h("span", { key: '1215ab0a61be24a701cee53c5b8b57f31665dcea', part: "control", class: "checkbox__control" }, this.checked ? (index.h("span", { part: "checked-icon", class: "checkbox__icon" }, index.h("svg", { viewBox: "0 0 16 16" }, index.h("g", { stroke: "none", "stroke-width": "1", fill: "none", "fill-rule": "evenodd", "stroke-linecap": "round" }, index.h("g", { stroke: "currentColor", "stroke-width": "2" }, index.h("g", { transform: "translate(3.428571, 3.428571)" }, index.h("path", { d: "M0,5.71428571 L3.42857143,9.14285714" }), index.h("path", { d: "M9.14285714,0 L3.42857143,9.14285714" }))))))) : (''), !this.checked && this.indeterminate ? (index.h("span", { part: "indeterminate-icon", class: "checkbox__icon" }, index.h("svg", { viewBox: "0 0 16 16" }, index.h("g", { stroke: "none", "stroke-width": "1", fill: "none", "fill-rule": "evenodd", "stroke-linecap": "round" }, index.h("g", { stroke: "currentColor", "stroke-width": "2" }, index.h("g", { transform: "translate(2.285714, 6.857143)" }, index.h("path", { d: "M10.2857143,1.14285714 L1.14285714,1.14285714" }))))))) : (''), index.h("input", { key: '178560b67dd89248bd39732caec144058a655774', id: this.inputId, ref: el => (this.input = el), type: "checkbox", name: this.name, value: this.value, checked: this.checked, disabled: this.disabled, required: this.required, role: "checkbox", "aria-checked": this.checked ? 'true' : 'false', "aria-labelledby": this.labelId, onClick: () => this.handleClick(), onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus() })), index.h("span", { key: '31ddbcea3a35eba9c0df04b3401657c3fb31e070', part: "label", id: this.labelId, class: "checkbox__label" }, index.h("slot", { key: 'd31d548b1923f1f9b2a2615960082ad5a76f3ace' }))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const ScTaxIdInput = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (index.h(index.Fragment, { key: '308c6848e3dae1c612fc5d97abfd75230202135d' }, index.h("sc-input", { key: '4c4876c2ff8ec3f87d594cd23ec91615b1240088', name: "tax_identifier.number_type", required: this.required, value: this.type, style: { display: 'none' } }), index.h("sc-input", { key: 'cf6908433a4ac24dcb7e44075170b0ef34e8a8e6', ref: el => (this.input = el), label: this.getZoneLabel(), "aria-label": wp.i18n.__('Tax ID', 'surecart'), placeholder: wp.i18n.__('Enter Tax ID', 'surecart'), name: "tax_identifier.number", value: this.number, onScInput: (e) => {
