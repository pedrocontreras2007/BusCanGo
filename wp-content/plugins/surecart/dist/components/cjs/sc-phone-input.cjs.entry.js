...
const ScPhoneInput = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '2f26f8d0878a300baefc44ad9fb7af03ab61cf63', hidden: this.hidden }, index.h("sc-form-control", { key: '0c1b6b1bae9fcc358095644a2bc671cfbb2252e5', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name, "aria-label": this.label }, index.h("slot", { key: '51d57386c77054d73b40e0d69b18d8db16a65dbe', name: "label-end", slot: "label-end" }), index.h("div", { key: '480219c0858908e6d2e41bb0f68108f92f142880', part: "base", class: {
                'input': true,
                // Sizes
            ...
            } }, index.h("span", { key: 'd7c6334cf465093cf3e4c1e749d4ad3f7622a00b', part: "prefix", class: "input__prefix" }, index.h("slot", { key: '78d7419747963c05da6c7afabbf7bdbf4ce87f8a', name: "prefix" })), index.h("slot", { key: 'f57f60f703a4540c4ed0b34a2bdec428850b0c42' }, index.h("input", { key: 'cf4db1b48ec3ae299ebb7c45fde21bc9ed30e983', part: "input", id: this.inputId, class: "input__control", ref: el => (this.input = el), type: "tel", name: this.name, disabled: this.disabled, readonly: this.readonly, required: this.required, placeholder: this.placeholder, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step,
            // TODO: Test These below
            autocomplete: 'tel', autocorrect: this.autocorrect, autofocus: this.autofocus, spellcheck: this.spellcheck, pattern: index$1.applyFilters('surecart/sc-phone-input/pattern', this.pattern), inputmode: 'numeric', "aria-label": this.label, "aria-labelledby": this.label, "aria-invalid": this.invalid ? true : false, value: this.value, onChange: () => this.handleChange(), onInput: () => this.handleInput(), onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur() })), index.h("span", { key: '2a9726b241a203a62576a2e45a421ad1510d546a', part: "suffix", class: "input__suffix" }, index.h("slot", { key: 'b230029ef015e9f6eabdf853e71dc8479c34cde5', name: "suffix" })), this.clearable && ((_a = this.value) === null || _a === void 0 ? void 0 : _a.length) > 0 && (index.h("button", { key: 'f29da7f083eeedcc049870c6df08ce20c01d61ef', part: "clear-button", class: "input__clear", type: "button", onClick: e => this.handleClearClick(e), tabindex: "-1" }, index.h("slot", { key: 'a84f4ebcd5abbbfc41c42fbecfbb082a09a1b641', name: "clear-icon" }, index.h("svg", { key: 'caa42a54047420b4cd48f08fdd782c6bb24d8db6', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "feather feather-x" }, index.h("line", { key: '3318e10c8316595b2865a5c3057b79756a1fd308', x1: "18", y1: "6", x2: "6", y2: "18" }), index.h("line", { key: 'ee54dd1901b91be77e30bc1c36db667842064fdb', x1: "6", y1: "6", x2: "18", y2: "18" })))))))));
    }
