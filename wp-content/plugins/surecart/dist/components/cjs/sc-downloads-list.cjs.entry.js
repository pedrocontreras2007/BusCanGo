...
const ScDownloadsList = class {
    ...
    render() {
        ...
        return (index.h("sc-dashboard-module", { key: '47ed81ab4f598c4e73c9292fbb5b799415ee6939', class: "purchase", part: "base", heading: wp.i18n.__('Downloads', 'surecart') }, index.h("span", { key: 'dc6c784f5be2a9ff78dff82c5a1493f6e3d93610', slot: "heading" }, index.h("slot", { key: 'fa33bf943ed50bda076f9af8a412363a2821cbbc', name: "heading" }, this.heading || wp.i18n.__('Downloads', 'surecart'))), index.h("sc-card", { key: '14306b4323b9941b46c8664f8c8207fd3ca6c90f', "no-padding": true }, index.h("sc-stacked-list", { key: 'ebc5bb7555d9852f78f976f717f48a51af25746c' }, downloads.map(download => {
            var _a, _b, _c, _d;
