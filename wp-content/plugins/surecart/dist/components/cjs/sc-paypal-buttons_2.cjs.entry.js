...
const ScPaypalButtons = class {
    ...
    render() {
        return (index.h("div", { key: 'b3e78db70364a1d9e33c6c3f08850f1dc232188c', part: `base ${this.busy || (!this.loaded && 'base--busy')}`, class: { 'paypal-buttons': true, 'paypal-buttons--busy': this.busy || !this.loaded } }, (!this.loaded || this.busy) && index.h("sc-skeleton", { key: 'efa921a9c34573ecf9c300729897a1d0723cac67', style: { 'height': '55px', '--border-radius': '4px', 'cursor': 'wait' } }), index.h("div", { key: 'a7db6fb94c43254316b94b60e9cb46bd1455587a', class: "sc-paypal-button-container", hidden: !this.loaded || this.busy }, index.h("div", { key: '0a5a025464125ba94c7fe67c74be5ea166d5bde9', part: "paypal-card-button", hidden: !this.buttons.includes('card'), class: "sc-paypal-card-button", ref: el => (this.cardContainer = el) }), index.h("div", { key: '54b8ec6cd87654da878fff0bb4dc6c869a7095e9', part: "paypal-button", hidden: !this.buttons.includes('paypal'), class: "sc-paypal-button", ref: el => (this.paypalContainer = el) }))));
    }
...
const ScSecureNotice = class {
    ...
    render() {
        return (index.h("div", { key: '1a6a22b5b7e55a2edb720e631bc0403a0b0d3808', class: "notice", part: "base" }, index.h("svg", { key: '873cb005b86fadaa3772f808024ac4af51e6acef', class: "notice__icon", part: "icon", xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 512 512", fill: "currentColor" }, index.h("path", { key: '34757283995c1ffe8bdfbf635a547da531a77ce0', d: "M368,192H352V112a96,96,0,1,0-192,0v80H144a64.07,64.07,0,0,0-64,64V432a64.07,64.07,0,0,0,64,64H368a64.07,64.07,0,0,0,64-64V256A64.07,64.07,0,0,0,368,192Zm-48,0H192V112a64,64,0,1,1,128,0Z" })), index.h("span", { key: '7d4adf4fcaa8bab1ef6151bcaa152d3ee7f64b6b', class: "notice__text", part: "text" }, index.h("slot", { key: 'f0f3afb22f1d28fc7e14ef522089b0317f4f8187', name: "prefix" }), index.h("slot", { key: 'a0c289b518ee7a2f551f1b0cfddec040d9583035' }), index.h("slot", { key: '3a06599fa1d248417ccead49d0719fb185e0be25', name: "suffix" }))));
    }
};
