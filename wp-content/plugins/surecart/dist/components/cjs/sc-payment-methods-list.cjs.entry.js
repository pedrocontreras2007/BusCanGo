...
const ScPaymentMethodsList = class {
    ...
    render() {
        return (index.h("sc-dashboard-module", { key: '0ac80f9fda075ae4829fbbe03c414221010b20ba', class: "payment-methods-list", error: this.error }, index.h("span", { key: '1c98a5c652a987b7723b94750d1b63602cf83799', slot: "heading" }, index.h("slot", { key: '458d481338136b9faf5fad827cd5791c93eab0d3', name: "heading" }, this.heading || wp.i18n.__('Payment Methods', 'surecart'))), this.isCustomer && (index.h("sc-flex", { key: '43538e9893e920b2318b3cdf8add46cca1507e76', slot: "end" }, index.h("sc-button", { key: '06979322168db93d3f4fb682bab61f5248690430', type: "link", href: addQueryArgs.addQueryArgs(window.location.href, {
                action: 'index',
                model: 'charge',
            }) }, index.h("sc-icon", { key: 'a85ef3259390284fc15a993a5eeea94c17047b54', name: "clock", slot: "prefix" }), wp.i18n.__('Payment History', 'surecart')), index.h("sc-button", { key: '27ce21d0667c5a4974edcb46b372970fe5448519', type: "link", href: addQueryArgs.addQueryArgs(window.location.href, {
                action: 'create',
                model: 'payment_method',
            }) }, index.h("sc-icon", { key: 'c844878bbf69207359439c6e84814d6375045514', name: "plus", slot: "prefix" }), wp.i18n.__('Add', 'surecart')))), this.renderContent(), index.h("sc-dialog", { key: '2676d6388a35809831f6229215320c150778000b', open: !!this.editPaymentMethod, label: wp.i18n.__('Update Default Payment Method', 'surecart'), onScRequestClose: () => (this.editPaymentMethod = false) }, index.h("sc-alert", { key: '28a646a4e263121e35a376ba687ee3bc7733fb08', type: "danger", open: !!this.error }, this.error), index.h("sc-flex", { key: '6aad98329670e1235f3e259e71ac47436ec97cc1', flexDirection: "column", style: { '--sc-flex-column-gap': 'var(--sc-spacing-small)' } }, index.h("sc-alert", { key: 'b9da67346f5453a7371b2cd4dfe18b8236578b2c', type: "info", open: true }, wp.i18n.__('A default payment method will be used as a fallback in case other payment methods get removed from a subscription.', 'surecart')), index.h("sc-switch", { key: '431b19ea6a3874f26df33ff621870dc7b5025c59', checked: this.cascadeDefaultPaymentMethod, onScChange: e => (this.cascadeDefaultPaymentMethod = e.target.checked) }, wp.i18n.__('Update All Subscriptions', 'surecart'), index.h("span", { key: 'a6e9796449e7e803167a75d41d5eb81a8396f675', slot: "description" }, wp.i18n.__('Update all existing subscriptions to use this payment method', 'surecart')))), index.h("div", { key: '9963324d7a86fb45ebddfd27c24c1fd981e5d4da', slot: "footer" }, index.h("sc-button", { key: '70cd3903dd566b08e712fbf56e387cf262f7389b', type: "text", onClick: () => (this.editPaymentMethod = false) }, wp.i18n.__('Cancel', 'surecart')), index.h("sc-button", { key: 'b05d07b8cad9a9e40e6320e2cd5705a7bca08453', type: "primary", onClick: () => this.setDefault() }, wp.i18n.__('Make Default', 'surecart'))), this.busy && index.h("sc-block-ui", { key: '276e152f1ba2c7b333efedec087346cd95b02d20', spinner: true })), index.h("sc-dialog", { key: '7d859e318c4d14a5f885c8838b3f089a7ea3ee71', open: !!this.deletePaymentMethod, label: wp.i18n.__('Delete Payment Method', 'surecart'), onScRequestClose: () => (this.deletePaymentMethod = false) }, index.h("sc-alert", { key: 'c8cb0e2747ff6df79df46a8ed1fb97c2a4e626f8', type: "danger", open: !!this.error }, this.error), index.h("sc-text", { key: 'bbb353bc799b00270b8e195e618e059d3bd2f049' }, wp.i18n.__('Are you sure you want to remove this payment method?', 'surecart')), index.h("div", { key: 'c3cb78e2bd4ed816217a9e28d5904127a36ceb38', slot: "footer" }, index.h("sc-button", { key: 'b76485391ec921f52bbf05682df01da33cb181c4', type: "text", onClick: () => (this.deletePaymentMethod = false) }, wp.i18n.__('Cancel', 'surecart')), index.h("sc-button", { key: 'cef6cee245c579c292ed890215cdef7fa076ddd7', type: "primary", onClick: () => this.deleteMethod() }, wp.i18n.__('Delete', 'surecart'))), this.busy && index.h("sc-block-ui", { key: '0b3f15837d10333995e5b34da5dceb0f77a53202', spinner: true })), this.busy && index.h("sc-block-ui", { key: '9c9d1dee23d6acf93d3b03495ab5a00b7535a76d', spinner: true })));
    }
